...
| 组件 | 规格 |
| --- | --- |
| 应用骨架（appbar） | 吸顶深底导航：logo（中/英）+ global-nav（报告/真实性说明/数据集/总门户）+ 右上「明暗」按钮;四件套同目录时指向对应文件,纯单页可整段删除 |
| 面包屑（breadcrumb） | 总门户 / 年度 / 本门户;相对路径;纯单页可整段删除 |
